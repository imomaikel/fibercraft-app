          ...
          <nav>
            <div className="flex w-full items-center justify-between">
              <div className="flex items-center space-x-2 sm:space-x-6">
                <div className="lg:hidden" role="button" aria-labelledby="open sidebar" onClick={openMobileNav}>
                ...
                >
                  <div className="group relative flex h-16 items-center lg:px-4">
                    <Image
                      alt="logo"
                      src="/fiber.webp"
                      ...
                      height={48}
                    />
                    <h1 className="text-xl font-extrabold antialiased sm:tracking-wide lg:ml-4 lg:text-3xl">
                      FiberCraft
                    </h1>
                    <div className="absolute inset-0 -z-10 hidden rounded-full bg-gradient-to-l from-muted/50 to-primary/50 opacity-50 lg:block" />
                  </div>
                </Link>
