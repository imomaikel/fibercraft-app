  ...
  return (
    <div>
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: [0, 1] }}
        className="absolute left-0 top-0 -mt-10"
      >
        <svg width={400} height={200} viewBox="120 15 150 200">
          <path
            fill="transparent"
            id="curve"
            d="M6,150C49.63,93,105.79,36.65,156.2,47.55,207.89,58.74,213,131.91,264,150c40.67,14.43,108.57-6.91,229-145"
          />
          <text x="25" fill="white" className="text-lg font-medium tracking-wide">
            <textPath xlinkHref="#curve">Scroll Down For More</textPath>
          </text>
        </svg>
      </motion.div>
      <div style={{ transform: 'rotate(270deg)  scale(-1, 1)' }}>
        <motion.svg
          height="200"
          width="200"
          fill="none"
