...
const Footer = () => {
  ...
  return (
    <div className="arial absolute bottom-0 z-10 flex min-h-[35px] w-full flex-col items-center justify-between bg-secondary px-4 py-1 text-[11px] font-normal text-[#B2B2B2] md:flex-row md:px-8 md:py-0">
      {/* Logo and text */}
